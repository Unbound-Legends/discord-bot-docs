---
title: Discord Bot
description: Documentation for the RPG Sessions Discord Bot
slug: discord-bot
---
...
- **Dice Rolling** — Roll any dice directly in Discord with full support for Star Wars RPG dice
- **Character Management** — View and share character sheets, stats, and abilities
- **Initiative Tracking** — Manage combat turn order automatically
- **Game Table Sync** — Connect your Discord server to your RPG Sessions game table
- **In-Character Messages** — Send messages as your characters for immersive roleplay
